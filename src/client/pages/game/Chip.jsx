...
export const Chip = ({ value, width = 40, height = 40 }) => {
  ...
  return <div style={{
    color: 'white', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center',
    width: width + 'px',
    height: height + 'px',
    userSelect: 'none'
  }}>
    <div style={{ color: 'red', position: 'absolute', width: width + 'px', height: height + 'px' }}>
      <svg stroke={color} fill={color} height={`${height}px`} width={`${width}px`} version="1.1" xmlns="http://www.w3.org/2000/svg"
        viewBox="-10 -10 320 320" >

        <circle fill="black" cx="148" cy="148" r="155" />
        <circle fill="white" cx="150" cy="150" r="140" />
    ...
    <span style={{ marginLeft: `${margin}px`, fontSize: '10px', fontWeight: 'bold', zIndex: 1 }}>{value}</span>
